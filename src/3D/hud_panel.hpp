...
struct DebugPanelInfo {
    ...
    bool idleModeEnabled = false; // false by default as to not have things freeze ever 3s
...
inline void drawDebugPanel(const GLBitmapFont& font, const DebugPanelInfo& d, int sw, int sh) {
    ...
    int rows = 1 /*shader*/ + 2 /*compiled*/
             ...
             + 1 /*render*/ + 3 /*steps/cinematic/idle-mode*/
    ...
    kv("Idle Mode",   d.idleModeEnabled ? "ON" : "OFF",
       d.idleModeEnabled ? col::valueOn : col::valueOff);
    divider();
